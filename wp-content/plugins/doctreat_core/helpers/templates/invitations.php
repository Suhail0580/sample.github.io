...
if (!class_exists('DoctreatInvitationsNotify')) {
    ...
    class DoctreatInvitationsNotify extends Doctreat_Email_helper{
		...
		public function send_hospitals_email($params = '') {
			...
			extract($params);
			$email_to 			= $email;
			$subject_default 	= esc_html__('Invitation to signup', 'doctreat_core');
			...
			$subject		= !empty( $theme_settings['invite_hospitals_subject'] ) ? $theme_settings['invite_hospitals_subject'] : $subject_default;
			
			$email_content	= !empty( $theme_settings['invite_hospitalss_content'] ) ? $theme_settings['invite_hospitalss_content'] : $contact_default;
		...
		public function send_doctors_email($params = '') {
			...
			$subject		= !empty( $theme_settings['invite_doctors_subject'] ) ? $theme_settings['invite_doctors_subject'] : $subject_default;
			$email_content	= !empty( $theme_settings['invite_doctors_content'] ) ? $theme_settings['invite_doctors_content'] : $contact_default;
